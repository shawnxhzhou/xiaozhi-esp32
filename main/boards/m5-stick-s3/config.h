...
// 引脚以官方原理图 I/Os Map 为准（M5 文档页 DDAC/DADC 容易和 DOUT/DIN 搞混）
#define AUDIO_I2S_GPIO_MCLK  GPIO_NUM_18  // I2S_MCLK
#define AUDIO_I2S_GPIO_BCLK  GPIO_NUM_17  // I2S_BLCK
#define AUDIO_I2S_GPIO_WS    GPIO_NUM_15  // I2S_LRCK
#define AUDIO_I2S_GPIO_DIN   GPIO_NUM_16  // I2S_DADC（mic → ESP）
#define AUDIO_I2S_GPIO_DOUT  GPIO_NUM_14  // I2S_DDAC（ESP → speaker）
...
// Arduino BSP TFT_BACKLIGHT_ON HIGH，确认是高电平点亮
#define DISPLAY_BACKLIGHT_OUTPUT_INVERT  false

// M5PM1 电源管理芯片（PY32L020 mcu）的 I2C 地址
